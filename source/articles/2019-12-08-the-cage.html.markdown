...
While on tour supporting his recent [You've Changed](https://youvechangedrecords.com/) LP *Transistor Sister 2*, [Shotgun Jimmie](https://shotgunjimmie.net/) took some time off the road to record a stripped-down little four-song EP with Saskatoon's [Little Jack Films](https://www.littlejackfilms.com/). The resulting set's titled *VHS* after the vintage tech used in its creation (a pair of late-80s cameras - an RCA CC300 and Panasonic Omnimovie to be specific - with audio recorded to cassette). The label describes the throwback sound captured in the October 11 session:
