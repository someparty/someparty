...
Last Friday Montreal's [Planet Smashers](https://www.facebook.com/ThePlanetSmashers) shared the title track to their upcoming ninth full-length, *Too Much Information*. You can stream the song below and expect a video for the tune to arrive sometime this week. The third-wave ska band will see the 14-song new record arrive on May 10 through [Stomp Records](https://stomprecords.com/). There's a massive array of vinyl variants available for this sucker, so check Bandcamp for all the details if you're a collector.
