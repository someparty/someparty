...
Last week the Toronto synthpop group [Sahara](https://saharatoronto.bandcamp.com/) released their debut full-length on [Hand Drawn Dracula](https://www.handdrawndracula.com). *Pure Glass* features nine songs that call back to the Cure's early sound, by way of 90s shoegaze. You can stream it everywhere now.
