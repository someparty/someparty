...
Antibodies recently saw their 2018 and 2019 material collected onto a single 20-song LP by the UK label [Drunken Sailor Records](http://www.drunkensailorrecords.co.uk). It's to be followed soon by a new 7" EP in the works at [Sewercide Records](http://sewerciderecords.blogspot.com/), due later this year.
...
Trevor McEachran's Vancouver-based punk outfit [Industrial Priest Overcoats](https://codyellen.bandcamp.com/) have a new single online titled "The Covenant House Kidz Reunion," the first track shared from the upcoming record *Transformer Story*.

That set, due later this year, will follow 2019's full-length *The Years Barely Left a Trace*. If this track's any indication, expect the new material to carry on the unpredictable weirdo-pop vibes of that those earlier releases (not to forget the fantasically off-kilter [Bedwetters Anonymous](https://bedwettersanonymous.bandcamp.com/), which also features McEachran).
