...
You can snag the 10-song alt-country set *"Visions Of The Higher Dream"* now on Bandcamp, but move quickly. The record follows his latest full-length *Finally Free*, which arrived in 2018 from [You've Changed](http://youvechangedrecords.com/) and [New West Records](http://newwestrecords.com/). This feels like a curious piece of music to release on a whim, as it's rather lushly orchestrated. It certainly doesn't sound like some tossed-off set of demos, but if anyone had fully a realized LP just sitting around in a drawer, Daniel Romano would be that person.
...
Steven Lambke recently released the full-length *Dark Blue* through [You've Changed Records](http://youvechangedrecords.com/).
