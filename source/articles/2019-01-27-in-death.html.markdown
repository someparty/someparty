...
On the heels of a pair of recent singles, Toronto punk quartet [Pkew Pkew Pkew](https://www.pkewx3.com/) have formally announced their new LP. Titled *Optimal Lifestyles*, the band's 15-song new record will arrive on March 1 via [Dine Alone](https://dinealonerecords.com/). With the announcement, the group unveiled the new track "I Don't Matter At All," which follows the previously shared "65 Nickels" and "Passed Out."
...
Whimsical Montreal art-punk duo [CRABE](http://crabe.bandcamp.com) recently released the song "Livre compliqué," the first taste of the band's next record. That album, the band's 7th, is due in the spring from [Pantoum Records](https://www.lepantoum.com/). I'm unsure of its title at the moment, as my French is embarrassingly bad. Originally hailing from the southwestern Quebec town of Salaberry-de-Valleyfield, CRABE features Gabriel Lapierre and Mertin Höek. Guillaume Chiasson of the Quebec City garage rock duo [Ponctuation](https://ponctuationponctuation.bandcamp.com/) produced the new track.
