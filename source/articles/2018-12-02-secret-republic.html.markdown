...
The split between [Daniel Romano](https://www.danielromanomusic.com/)'s power-pop group [Ancient Shapes](http://ancientshapes.bandcamp.com) and the Welland's Turbonegro-inspired trio [Dboy](https://dboyintl.bandcamp.com) is out now. You can hear the songs over at the [Yeah Right! Records](http://yeahrightrecords.com/) Bandcamp page. The 7" features two new tracks from both groups.
