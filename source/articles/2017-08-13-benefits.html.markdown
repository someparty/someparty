...
Toronto's [Flatliners](http://www.theflatliners.com/) have unveiled a new video for the song "Indoors" from their latest album *Inviting Light* (Dine Alone / Rise). There are a few well-known Toronto scene personalities that make appearances in as karaoke singers in the clip.
