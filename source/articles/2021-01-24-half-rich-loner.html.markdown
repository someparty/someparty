...
Oliver Ackermann of Brooklyn noisemakers A Place to Bury Strangers mastered the new set. It arrives on vinyl from [Bonsound](https://www.bonsound.com)'s garage imprint Blow The Fuse (one of the pre-order bundles notably includes a hand-crafted poster by the artist, unique per order).
