...
Send the email to the test subscriber, noting the exact file name of the generated article HTML (in this example, "2026-05-10-irish-goodbyes") you wish to send:

```
ruby send.rb -p 2026-05-10-irish-goodbyes -r test.json
```
...
```
ruby send.rb -p 2026-05-10-irish-goodbyes -r recipients.json
```
