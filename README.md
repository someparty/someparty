...
Send the email to the test subscriber, noting the exact file name of the generated article HTML (in this example, "2025-08-17-seed") you wish to send:

```
ruby send.rb -p 2025-08-17-seed -r test.json
```
...
```
ruby send.rb -p 2025-08-17-seed -r recipients.json
```
