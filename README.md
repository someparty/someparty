...
Send the email to the test subscriber, noting the exact file name of the generated article HTML (in this example, "2024-02-29-ripping-invasives") you wish to send:

```
ruby send.rb -p 2024-02-29-ripping-invasives -r test.json
```
...
```
ruby send.rb -p 2024-02-29-ripping-invasives -r recipients.json
```
