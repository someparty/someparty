...
Send the email to the test subscriber, noting the exact file name of the generated article HTML (in this example, "2025-01-25-controlfreak69") you wish to send:

```
ruby send.rb -p 2025-01-25-controlfreak69 -r test.json
```
...
```
ruby send.rb -p 2025-01-25-controlfreak69 -r recipients.json
```
