...
Send the email to the test subscriber, noting the exact file name of the generated article HTML (in this example, "2025-02-11-outta-my-head") you wish to send:

```
ruby send.rb -p 2025-02-11-outta-my-head -r test.json
```
...
```
ruby send.rb -p 2025-02-11-outta-my-head -r recipients.json
```
