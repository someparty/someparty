...
Send the email to the test subscriber, noting the exact file name of the generated article HTML (in this example, "2025-12-14-middle-of-summer") you wish to send:

```
ruby send.rb -p 2025-12-14-middle-of-summer -r test.json
```
...
```
ruby send.rb -p 2025-12-14-middle-of-summer -r recipients.json
```
