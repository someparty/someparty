...
Send the email to the test subscriber, noting the exact file name of the generated article HTML (in this example, "2026-03-31-good-heart-dumb-brain") you wish to send:

```
ruby send.rb -p 2026-03-31-good-heart-dumb-brain -r test.json
```
...
```
ruby send.rb -p 2026-03-31-good-heart-dumb-brain -r recipients.json
```
