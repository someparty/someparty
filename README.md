...
Send the email to the test subscriber, noting the exact file name of the generated article HTML (in this example, "2025-03-05-brutal-planet") you wish to send:

```
ruby send.rb -p 2025-03-05-brutal-planet -r test.json
```
...
```
ruby send.rb -p 2025-03-05-brutal-planet -r recipients.json
```
